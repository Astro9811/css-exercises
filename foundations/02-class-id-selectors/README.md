...
* **All odd numbered elements**: a light red/pink background rgb(255, 167, 167), and a list of fonts containing `Verdana` and `DejaVu Sans` with `sans-serif` as a fallback
* **The second element**: blue text #0000ff and a font size of 36px
* **The third element**: in addition to the styles for all odd numbered elements, add a font size of 24px
* **The fourth element**: a light green background hsl(120, 100%, 75%), a font size of 24px, and bold
